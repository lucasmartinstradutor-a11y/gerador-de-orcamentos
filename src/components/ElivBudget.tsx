...
export const ElivBudget: React.FC = () => {
    ...
    const handleGenerateDocx = async (type: 'comum' | 'uni') => {
        // Use relative paths instead of absolute to avoid server configuration issues.
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(`Não foi possível encontrar o template em '${templatePath}'. Certifique-se de que a pasta 'templates' existe na raiz do seu projeto e contém os arquivos 'ELIV_Comum.docx' e 'ELIV_Universidade.docx'.`);
            }
