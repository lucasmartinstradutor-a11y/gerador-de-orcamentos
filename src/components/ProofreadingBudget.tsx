...
import { PrintableBudget } from './PrintableBudget';
import { CopyIcon, PrinterIcon, CheckIcon, FileTextIcon } from './common/Icons';
...
export const ProofreadingBudget: React.FC = () => {
